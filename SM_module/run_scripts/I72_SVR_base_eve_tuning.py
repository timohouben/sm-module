...
for max_num,max_name in zip([1000,5000,10000,50000], ["1k","5k", "10k","50k"]):
    ...
    details = max_name
    estimator = SVR(max_iter=max_num, kernel='linear', epsilon = 0.02, gamma = 'scale')
    ...
    # train the model
    st_model.train_test(train_with_cv=True, tuning_hyperparameters={'C':[0.01,0.05,0.1,0.5,1]})
