...
name = "SK"
method_name = "SVR"
features = ["P_mm","PET_mm","Elevation[m]","Silt%","Clay%","Sand%","Porosity%","dist_to_creek","twi","relief_1","relief_2","relief_3","hillshade","rugg_idx","slope","aspect","ele_dem","Temp"]
print("Testing with features: ")
print(features_base)
# mandatory variables
method = method_name + "_all"
details = features
st_model1 = SpatioTempModel(
	    ...
	    project_dir = project_dir)
# train the model
st_model1.train_test(train_with_cv=True, tuning_hyperparameters={'kernel':['linear','rbf'],
                                                                'epsilon':[0.01,0.05,0.1,0.5,10,100],
                                                                'C':[0.1,0.5,1.0,1.5,10,100]})
# plot true vs predicted values
...
name = "SK"
method_name = "SVR"
features_subset = ["P_mm","PET_mm","Elevation[m]","Silt%","Clay%","Sand%","Porosity%","dist_to_creek","twi","relief_1","relief_2","relief_3","hillshade","rugg_idx","slope","aspect","ele_dem","Temp"]
print("Testing with features: ")
print(features_base)
# mandatory variables
...
st_model2 = SpatioTempModel(
	    ...
	    project_dir = project_dir)
# train the model
st_model2.train_test(train_with_cv=True, tuning_hyperparameters={'kernel':['linear','rbf'],
                                                                'epsilon':[0.01,0.05,0.1,0.5,10,100],
                                                                'C':[0.1,0.5,1.0,1.5,10,100]})
# plot true vs predicted values
